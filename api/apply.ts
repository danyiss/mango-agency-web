...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  const { name, instagram, contact, telegram, email, situation, goal, service, income, heardFrom, heardDetail } = req.body || {};
  ...
  try {
    ...
    await persistToPortal({ source: 'model', name, email, instagram, contact, telegram, situation, goal, service, income, heardFrom: heardDetailText ? `${heardFrom}: ${heardDetailText}` : heardFrom });
