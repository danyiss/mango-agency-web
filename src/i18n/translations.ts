...
export const translations = {
  en: {
    ...
    'home.faq.a11': "MANGO operates on a performance-based payment model: the agency earns a percentage of incremental revenue, meaning it only makes money when the creator makes more money than they were making before. There are no upfront fees, no monthly retainers and no fixed minimums. The exact percentage and the baseline revenue used for calculation are agreed during the evaluation call, and they depend on the creator's starting position and the level of operational support required. Payments are calculated monthly against transparent revenue dashboards both sides can see in real time. This model exists because it aligns incentives — the agency only invests time in creators where the growth runway is real, and creators never pay for performance that does not show up in their bank account. If the numbers don't move, neither does the invoice.",
  ...
  es: {
    ...
    'home.faq.a11': 'MANGO opera con un modelo de pagos basado en rendimiento: la agencia gana un porcentaje del ingreso incremental, lo que significa que solo gana dinero cuando la creadora gana m\u00e1s dinero del que ganaba antes. No hay fees por adelantado, retainers mensuales ni m\u00ednimos fijos. El porcentaje exacto y la l\u00ednea base de ingresos usada para el c\u00e1lculo se acuerdan durante la call de evaluaci\u00f3n y dependen del punto de partida de la creadora y del nivel de soporte operativo requerido. Los pagos se calculan mensualmente sobre dashboards de ingresos transparentes que ambas partes ven en tiempo real. Este modelo existe porque alinea incentivos \u2014 la agencia solo invierte tiempo en creadoras donde el runway de crecimiento es real, y las creadoras nunca pagan por rendimiento que no aparece en su cuenta bancaria. Si los n\u00fameros no se mueven, tampoco lo hace la factura.',
